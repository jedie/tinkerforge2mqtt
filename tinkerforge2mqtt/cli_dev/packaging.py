...
from tinkerforge2mqtt.cli_dev import PACKAGE_ROOT, app
...
def install():
    """
    Install requirements and 'tinkerforge2mqtt' via pip as editable.
    """
...
def publish():
    ...
    publish_package(module=tinkerforge2mqtt, package_path=PACKAGE_ROOT)
